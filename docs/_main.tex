...
\urlstyle{same}
\hypersetup{
  pdftitle={Genomics for Precision Oncology 2025},
  pdfauthor={Faculty: Daniel Gaston, Victor Martinez},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Genomics for Precision Oncology 2025}
...
\subsubsection{Dr.~Dan Gaston (he/him)}\label{dr.-dan-gaston-hehim}
...
--- \href{mailto:daniel.gaston@dal.ca}{\nolinkurl{daniel.gaston@dal.ca}}
\end{quote}
...
\subsubsection{Dr.~Victor Martinez}\label{dr.-victor-martinez}
...
\subsubsection{Riley Arseneau (she/her)}\label{riley-arseneau-sheher}
...
--- \href{mailto:Rarseneau@dal.ca}{\nolinkurl{Rarseneau@dal.ca}}
\end{quote}
